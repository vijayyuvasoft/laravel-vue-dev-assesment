                            ...
                            @foreach ($jobs as $job)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <img src="{{ '/storage/'.$job['logo'] }}" class="h-12 w-auto block mx-auto" alt="{{ $job['company_name'] }}">
                                    </td>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button wire:click="deleteJob({{ $job->id }})" class="text-sm px-3 py-1.5 rounded hover:bg-red-100 transition-colors text-red-500">
                                            Delete
                                        </button>
                                    </td>
